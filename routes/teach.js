...
const subContent = [
  {
    img: '<img  class="sub-content-image" src="../img/sub-content-stock/sub-content-stock4.jpg">',
    title: "Understand Your Revenue",
    text: "Many learning platforms make predicting how much you will earn from learners purchasing or watching your content opaque. In some cases, platforms control pricing and can change them unpredictably. <br /> <br />Pathways offers a standardized revenue model and the tools to monitor performance.",
  },
  {
    img: '<img  class="sub-content-image" src="../img/sub-content-stock/sub-content-stock5.jpg">',
  ...
  {
    img: '<img  class="sub-content-image" src="../img/sub-content-stock/sub-content-stock6.jpg">',
